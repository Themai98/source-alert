...
@property (nonatomic, strong) LDVQuang *apiKey; // Lưu trữ instance của LDVQuang API Key
...
// TOKEN API KEY
NSString * const __kHashDefaultValue = NSSENCRYPT("APIKEY-xLwPDgGlXeshMFEQmku8B9Y1SW6RfHr204dd9da258928e4722e75c72f108");
